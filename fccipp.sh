...
endipresult() {
	...
	"outbounds": [
		...
		"outbounds": [
			"auto",
			"IP->Iran, Instagram:meshki.poshm",
			"IP->Main, Instagram:meshki.poshm"
		],
		"default": "auto"
		},
		{
		...
		{
		"type": "wireguard",
		"tag": "IP->Iran, Instagram:meshki.poshm",
		"local_address": [
			"172.16.0.2/32",
			"'$publicKey'"
		],
		...
		{
		"type": "wireguard",
		"tag": "IP->Main, Instagram:meshki.poshm",
		"detour": "IP->Iran, Instagram:meshki.poshm",
		"local_address": [
			"172.16.0.2/32",
			"'$publicKey2'"
		],
